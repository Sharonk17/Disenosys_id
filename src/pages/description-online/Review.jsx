...
const Review = () => {
  ...
  return (
    <div className="font-dm-sans">
      ...
      <div className="bg-white rounded-xl shadow p-6 mb-6 lg:col-span-3 flex flex-col items-center justify-center">
        <p className="text-5xl font-bold">4.8</p>
        <span className="text-[#F8BC24]">★ ★ ★ ★ ★</span>
        <p className="text-gray-500">Course Rating</p>
        </div>
        {/* Rating bars */}
        <div className="space-y-2 bg-white rounded-xl shadow p-6 mb-6 lg:col-span-9">
